 ...
 * (@JoinColumn: specifica la collanna che fa chiave esterna in una relazione tra entità)
 * es.-> @ManyToOne o @OneToOne
 */
...
public class TestEntity {
	...
	public TestEntity(String nome, String descrizione, DettaglioTestEntity dettaglio) {
		...
		if(dettaglio != null) {
			dettaglio.setTest(this); // Mantiene la sincronizzazione
		}
	}
	...
	public void setDettaglio(DettaglioTestEntity dettaglio) {
		this.dettaglio = dettaglio;
		if(dettaglio != null) {
			dettaglio.setTest(this); // Sincronizzazione in Setter
		}
	}
